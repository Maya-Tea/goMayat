...
const SVGArray = [<StarSVG />, <YarnSVG />, <CatSVG />, <SelfieSVG />, <GaugeSVG />, <LotusSVG />];
        ...
        >
          ...
          >
            {screens.map((screen, i) => {
              const coors = this.polarToCartesian((i+1) * 60 + 30, DIMS.width * 0.025);
              const coors2 = this.polarToCartesian((i+1) * 60 + 30, this.iconRenderWidth * 1.5);
              let transX;
              let transY;
              ...
              return (
                <Animated.View
                  style={{
                    ...
                    transform: [ {scale: growIcons}, {translateX: transX}, {translateY: transY}, {rotate: rotateIconsPress },]
                  }}
                  key={screen, i}
                >
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      ...
                      const spinFactor = 7;
                      const setRotation = this.calcIconLocation((i+1) * 60 + 30);
                      ...
                      shrinkIconTimeout = setTimeout(this.shrinkIcons, setRotation * spinFactor + 600);
                      iconRotateBackTimeout = setTimeout(this.rotateIconGroupBack, setRotation * spinFactor + 1000);
                      shrinkLogoTimeout = setTimeout(this.shrinkLogo, setRotation * spinFactor + 600);
                    }}
                  >
                    <AnimatedSvg
                      style={{
